    ...
    <div class="header">
        <div class="container">
            ...
            <div class="navbar" id="mynavbar">
                ...
                <nav>
                    <!--Button to chat page-->
                    <button class="btn" type="button" name="accept" style="padding:10px; background: #e58679"><i class="fa fa-weixin" aria-hidden="true"></i></button>
                    <ul id="MenuItems">
...
<div class="row">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div>Nội dung</div> 
            <div>
                <button class="btn btn-success" type="submit" name="accept"><i class="fa fa-arrow-right" aria-hidden="true"></i> Chat now</button>
            </div>
        </li>
